...
System.register(['../models/ListaNegociacoes', '../models/Mensagem', '../view/NegociacoesView', '../view/MensagemView', '../services/NegociacaoService', '../helpers/DateHelpers', '../helpers/Bind', '../models/Negociacao'], function (_export, _context) {
  "use strict";
  ...
  return {
    ...
    }, function (_helpersDateHelpers) {
      DateHelper = _helpersDateHelpers.DateHelper;
        ...
        _createClass(NegociacaoController, [{
          ...
          value: function _init() {
            ...
            this._service.lista().then(function (negociacoes) {
              negociacoes.forEach(function (negociaco) {
                _this._listaNegociacoes.adiciona(negociaco);
              });
            }).catch(function (erro) {
              console.log(erro);
