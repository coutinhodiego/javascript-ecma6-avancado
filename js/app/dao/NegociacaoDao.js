                    ...
                    value: function listaTodos() {
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            cursor.onerror = function (e) {
                                console.log(e.target.error);
                                reject('Nao foi possivel listar todas as negociacoes.');
                            };
                        });
                    }
                }, {
                    key: 'apagarBanco',
                    value: function apagarBanco() {
                        var _this3 = this;
                        ...
                        return new Promise(function (resolve, reject) {
                            ...
                            request.onsuccess = function (e) {
                                resolve('Dados do banco apagado com sucesso!');
                            };

                            request.onerror = function (e) {
                                console.log(e.target.error);
                                reject('Nao foi possivel apagar os dados do banco.');
                            };
                        });
                    }
                }]);
